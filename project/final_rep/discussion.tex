...
The examples shown here are \texttt{libsodium}'s \codetext{sha256} and \codetext{sha512} implementations which the \ctVerif paper claimed could prove the constant-time property for, but which we were not able to replicate as discussed in \secref{tooling}
